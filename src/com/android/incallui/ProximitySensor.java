...
import static com.android.dialer.settings.GeneralSettingsFragment.BUTTON_SMART_SPEAKER_KEY;
import static com.android.dialer.settings.GeneralSettingsFragment.BUTTON_SMART_SPEAKER_INCALL_ONLY_KEY;
...
public class ProximitySensor implements AccelerometerListener.OrientationListener,
    ...
    private void setProximitySpeaker(final boolean proxSensorFar) {
        ...
        final int audioMode = mAudioModeProvider.getAudioMode();
        final boolean proxSpeakerEnabled = getSharedPreferenceBool(BUTTON_SMART_SPEAKER_KEY);
        final boolean proxSpeakerIncallOnlyPref = getSharedPreferenceBool(
                BUTTON_SMART_SPEAKER_INCALL_ONLY_KEY);
