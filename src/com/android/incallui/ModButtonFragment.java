...
public class ModButtonFragment
        ...
        implements ModButtonPresenter.ModButtonUi, OnMenuItemClickListener,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mModButtonRow = (LinearLayout) parent.findViewById(R.id.bottomModButtons);
        if (isDeviceProvisionedInSettingsDb(getActivity())) {
            mModButtonRow.setVisibility(View.VISIBLE);
        }
    ...
    public void updateColors() {
        ...
        if (mModButtonRow != null) {
            mModButtonRow.setBackgroundColor(mCurrentThemeColors.mSecondaryColor);
        }
    ...
    private RippleDrawable backgroundDrawable(MaterialPalette palette) {
        ...
        ColorStateList rippleColor = ColorStateList.valueOf(palette.mPrimaryColor);
    ...
    public void setEnabled(boolean isEnabled) {
        // Always enabled, not clickable till later.
        mInCallProvider.setEnabled(true);
    ...
    public void setDeepLinkNoteIcon(Drawable d) {
        if (d == null) {
            ...
            mTakeNoteButton.setVisibility(View.VISIBLE);
    ...
    private void createLayers(ImageButton button, Drawable icon) {
        ...
        final LayerDrawable layerDrawable = (LayerDrawable) button.getBackground();

        newIcon.setTintList(getResources().getColorStateList(R.color.selectable_icon_tint));
    ...
    public void enableButtonClicks() {
        ...
        mTakeNoteButton.setEnabled(true);
        final LayerDrawable layerDrawable = (LayerDrawable) mTakeNoteButton.getBackground();
        layerDrawable.setDrawableByLayerId(R.id.foregroundItem, mNoteDrawable);
