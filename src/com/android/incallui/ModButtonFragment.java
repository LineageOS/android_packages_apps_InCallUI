...
public class ModButtonFragment
        ...
        implements ModButtonPresenter.ModButtonUi, OnMenuItemClickListener, OnDismissListener,
        ...
        if (listSize == 1) {
            ...
            if (info != null && info.getPluginVideoIcon() != null) {
                final LayerDrawable layerDrawable
                        = (LayerDrawable) mInCallProvider.getBackground();

                int buttonWidth = mInCallProvider.getWidth();
                int buttonHeight = mInCallProvider.getWidth();
                ...
                mInCallProvider.setBackgroundDrawable(layerDrawable);
            }
        }
    }
    ...
    public void enableButtonClicks() {
        mInCallProvider.setClickable(true);
