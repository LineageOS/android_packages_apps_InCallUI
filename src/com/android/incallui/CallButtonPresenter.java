...
public class CallButtonPresenter extends Presenter<CallButtonPresenter.CallButtonUi>
    ...
    public static final String RECORDING_WARNING_PRESENTED = "recording_warning_presented";
    ...
    public void callRecordClicked(boolean startRecording) {
        ...
        if (startRecording) {
            ...
            boolean warningPresented = InCallApp.getPrefs(context)
                        ...
                        .setPositiveButton(R.string.menu_start_record,
                                new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        InCallApp.getPrefs(getUi().getContext())
                                                .edit()
