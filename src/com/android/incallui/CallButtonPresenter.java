...
public class CallButtonPresenter extends Presenter<CallButtonPresenter.CallButtonUi>
	...
	android.util.Log.d("foo", "active buttons " + activeButtonCount + " max buttons " + maxButtonCount);
        boolean needOverflow = activeButtonCount > maxButtonCount;
        int populatableButtonCount = maxButtonCount;
        if (needOverflow) {
            populatableButtonCount--;
        }
