...
public class DeepLinkIntegrationManager {
    ...
    public void setUp(Context ctx) {
        if(ambientIsAvailable(ctx)) {
            ...
            mAmbientApiClient =
                    new AmbientApiClient.Builder(ctx)
    ...
    private void sendEvent(Context ctx, DeepLink deepLink, ComponentName cn,
        ...
        HashMap<DeepLinkMetricsHelper.Parameters, Object>
                parameters = new HashMap<DeepLinkMetricsHelper.Parameters, Object>();

        parameters.put(DeepLinkMetricsHelper.Parameters.SOURCE, cn.flattenToString());
        parameters.put(DeepLinkMetricsHelper.Parameters.DESTINATION, deepLink.getPackageName());
        parameters.put(DeepLinkMetricsHelper.Parameters.CONTENT_TYPE,
                deepLink.getDeepLinkContentType());
        parameters.put(DeepLinkMetricsHelper.Parameters.DEST_APPLICATION_TYPE,
                deepLink.getApplicationType());
        parameters.put(DeepLinkMetricsHelper.Parameters.CONTENT_UID, deepLink.getUri().toString());
